...
adult$RACEHPR2 <- factor(adult$RACEHPR2, labels = factor(c("Latino", "Asian", "African American", "White")))

# Relabel the BMI categories variable:
adult$RBMI <- factor(adult$RBMI, labels = factor(c("Under-weight", "Normal-weight", "Over-weight", "Obese")))
